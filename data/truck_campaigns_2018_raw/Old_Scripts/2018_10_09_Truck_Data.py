...
for ii in range(1,len(lat_garmin_interp)):
	...
	if ( 90 - math.degrees(math.atan2( X , Y )) + 180 ) <= 360:
		car_d_garmin_pol.append( 90 - math.degrees(math.atan2( X , Y )) + 180)
	if ( 90 - math.degrees(math.atan2( X , Y )) + 180 ) > 360:
		car_d_garmin_pol.append( 90 - math.degrees(math.atan2( X , Y )) + 180 - 360)
...
plt.plot(garmin_time_w, car_d_garmin_pol, 'r+', label='Car Direction')
...
for ii in range(0,len(car_s_garmin)):
	U_c.append( car_s_garmin[ii] * math.cos( math.radians(car_d_garmin_pol[ii]) ) )
	V_c.append( car_s_garmin[ii] * math.sin( math.radians(car_d_garmin_pol[ii]) ) )
...
for ii in range(0,len(meteo_time)):
	for ll in range(0,len(garmin_time_w)):
			if meteo_time[ii].day == garmin_time_w[ll].day and meteo_time[ii].hour == garmin_time_w[ll].hour and meteo_time[ii].minute == garmin_time_w[ll].minute and meteo_time[ii].second == garmin_time_w[ll].second:
				...
				#if wind_speed[ii] > car_s_garmin[ll] :
				...
				#if math.sqrt( (U_w[ii] - U_c[ll])**2 + (V_w[ii] - V_c[ll])**2 ) > 8:
				#	print('!!!!!')
				#	print(wind_speed[ii], wind_direction_pol[ii])	
				#	print(car_s_garmin[ll], car_d_garmin_pol[ll])
...
for ii in range(0,len(Picarro_time)):
	...
	if pressure != 0:
		...
		nom_felix_interp.write("%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s\n" % (Picarro_time[ii],alt_gps_interp[ii],'amb[ii]',ch4[ii],ch4d[ii],'co[ii]',co2[ii],co2d[ii],'cod[ii]','cog[jj]','gasp[ii]',h2o[ii],'hdop[jj]','heading[jj]',lat_gps_interp[ii],lon_gps_interp[ii],pressure,'rd1[ii]','rd2[ii]','sog[jj]','t[ii]',temp,'wd_corr[jj]',wd_uncorr,'ws_corr[jj]',ws_uncorr))
	...
	if pressure == 0:
		...
		nom_felix_interp.write("%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s\n" % (Picarro_time[ii],alt_gps_interp[ii],'amb[ii]',ch4[ii],ch4d[ii],'co[ii]',co2[ii],co2d[ii],'cod[ii]','cog[jj]','gasp[ii]',h2o[ii],'hdop[jj]','heading[jj]',lat_gps_interp[ii],lon_gps_interp[ii],'Nan','rd1[ii]','rd2[ii]','sog[jj]','t[ii]','Nan','wd_corr[jj]','Nan','ws_corr[jj]','Nan'))
		nom_sebastien_interp.write("%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s\n" % (Picarro_time[ii],alt_garmin_interp[ii],'amb[ii]',ch4[ii],ch4d[ii],'co[ii]',co2[ii],co2d[ii],'cod[ii]','cog[jj]','gasp[ii]',h2o[ii],'hdop[jj]','heading[jj]',lat_garmin_interp[ii],lon_garmin_interp[ii],'Nan','rd1[ii]','rd2[ii]','sog[jj]','t[ii]','Nan','wd_corr[jj]','Nan','ws_corr[jj]','Nan'))
