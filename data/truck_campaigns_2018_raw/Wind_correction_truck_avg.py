...
wind_speed_5_avg = wind_speed_corr_both.rolling(window='300s').mean()
vxs_avg = vxs.rolling(window='300s').mean()
vys_avg = vys.rolling(window='300s').mean()
thetas_avg = np.degrees(np.arctan2(vys_avg, vxs_avg))
wind_direction_5_avg = (450 - thetas_avg) % 360

wind_speed_4_avg = wind_speed_corr_both.rolling(window='240s').mean()
vxs_avg = vxs.rolling(window='240s').mean()
vys_avg = vys.rolling(window='240s').mean()
thetas_avg = np.degrees(np.arctan2(vys_avg, vxs_avg))
wind_direction_4_avg = (450 - thetas_avg) % 360

wind_speed_3_avg = wind_speed_corr_both.rolling(window='180s').mean()
vxs_avg = vxs.rolling(window='180s').mean()
vys_avg = vys.rolling(window='180s').mean()
thetas_avg = np.degrees(np.arctan2(vys_avg, vxs_avg))
wind_direction_3_avg = (450 - thetas_avg) % 360

wind_speed_2_avg = wind_speed_corr_both.rolling(window='120s').mean()
vxs_avg = vxs.rolling(window='120s').mean()
vys_avg = vys.rolling(window='120s').mean()
thetas_avg = np.degrees(np.arctan2(vys_avg, vxs_avg))
wind_direction_2_avg = (450 - thetas_avg) % 360

wind_speed_1_avg = wind_speed_corr_both.rolling(window='60s').mean()
vxs_avg = vxs.rolling(window='60s').mean()
vys_avg = vys.rolling(window='60s').mean()
thetas_avg = np.degrees(np.arctan2(vys_avg, vxs_avg))
wind_direction_1_avg = (450 - thetas_avg) % 360
...
plt.plot(time_corr_both, wind_speed_1_avg,color='yellow',marker='o',linestyle="None",markersize=1,label="1' average")
plt.plot(time_corr_both, wind_speed_2_avg,color='orange',marker='o',linestyle="None",markersize=1, label="2' average")
plt.plot(time_corr_both, wind_speed_3_avg,color='red',marker='o',linestyle="None",markersize=1, label="3' average")
plt.plot(time_corr_both, wind_speed_4_avg,color='brown',marker='o',linestyle="None",markersize=1, label="4' average")
plt.plot(time_corr_both, wind_speed_5_avg,color='black',marker='o',linestyle="None",markersize=1, label="5' average")
#plt.plot(HEURE, WIND_SPEED, 'ko', label='Pearson wind')
plt.ylabel('Wind speed (m/s)')
plt.legend(loc=2,markerscale=6)
ax = plt.gca()
ax.xaxis.set_major_locator(md.MinuteLocator(interval=100))
ax.xaxis.set_major_formatter(md.DateFormatter('%H:%M:%S'))
plt.savefig("Speed_corr_both_averages_" + jour_mesure + ".png")
plt.close('all')

#plt.plot(meteo_time, wind_direction, 'cx', label='Measured wind')
plt.plot(time_corr_both, wind_direction_1_avg,color='yellow',marker='o',linestyle="None",markersize=1, label="1' average")
plt.plot(time_corr_both, wind_direction_2_avg,color='orange',marker='o',linestyle="None",markersize=1, label="2' average")
plt.plot(time_corr_both, wind_direction_3_avg,color='red',marker='o',linestyle="None",markersize=1, label="3' average")
plt.plot(time_corr_both, wind_direction_4_avg,color='brown',marker='o',linestyle="None",markersize=1, label="4' average")
plt.plot(time_corr_both, wind_direction_5_avg,color='black',marker='o',linestyle="None",markersize=1, label="5' average")
...
ax.xaxis.set_major_locator(md.MinuteLocator(interval=100))
ax.xaxis.set_major_formatter(md.DateFormatter('%H:%M:%S'))
plt.savefig("Direction_corr_both_averages_" + jour_mesure + ".png")
plt.close('all')
